...
// function getStartPayload(ctx: Context): number | null {
//   const message = ctx.message as { text?: string } | undefined
//   const text = message?.text || ""
//   const parts = text.split(" ")
//   if (parts.length > 1) {
//     const payload = Number.parseInt(parts[1], 10)
...
//       { caption: `Welcome to Bingo! (${agentsData[agentId].name})` },
//     )
...
//   // ✅ ONLY fires for contact messages, so it won't block /broadcast or any command
