  ...
  try {
    ...
    if (!backendResponse.ok) {
      ...
      return NextResponse.json(
        { 
          ...
          message: "Backend error while fetching daily accounting record",
          error: errorText,
          path: `/api/v1/accounting/daily/${id}`,
          timestamp: new Date().toISOString(),
          data: null as any
        },
    ...
    return NextResponse.json(
      { 
        success: false, 
        statusCode: 500,
        message: "Failed to fetch daily accounting record",
      ...
      return NextResponse.json(
        {
          success: false,
          statusCode: backendResponse.status,
          message: "Backend error while updating daily accounting record",
          error: errorText,
          path: `/api/v1/accounting/daily/${id}`,
          timestamp: new Date().toISOString(),
          data: null as any
    ...
    return NextResponse.json(
      {
        success: false,
        statusCode: 500,
        message: "Failed to update daily accounting record",
        error: error instanceof Error ? error.message : "Unknown error",
        timestamp: new Date().toISOString(),
        data: null as any
      },
