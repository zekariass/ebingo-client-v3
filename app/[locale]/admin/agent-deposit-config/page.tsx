...
import { AgentDepositConfig } from "@/components/admin/agent-deposit-config"
import { AlertCircle } from "lucide-react"

export default function AgentDepositConfigPage() {
  ...
  if (!agentId) {
    return (
      <div className="p-6">
        ...
        <p className="text-muted-foreground mt-2">
          Agent ID is required to manage the deposit config.
        </p>
      </div>
    )
  }

  return <AgentDepositConfig agentId={agentId} />
}
